            ...
            <div style="width: 50%">
              <div class="block-index-form">
                ...
                >
                  ...
                  <el-table-column prop="current" :label="toDay">
                  </el-table-column>
                  <el-table-column prop="last" :label="lastDay">
                  </el-table-column>
                </el-table>
              </div>
            </div>
        ...
        <div class="examineNum">
          ...
          <div style="display: flex; margin: 46px 26px 32px">
            <div>
              ...
              <div class="setFont" style="margin-top: 15px">今日</div>
              <div class="setBoldFont" style="margin: 15px 0">31</div>
              <div class="setFont">
                昨日
                <div class="setSecondFont">28</div>
              </div>
            </div>
            <div style="margin: 67px 50px 0 31px">
              <div class="setFont">
                接收白名单
                <div class="setSecondFont">31</div>
              </div>
